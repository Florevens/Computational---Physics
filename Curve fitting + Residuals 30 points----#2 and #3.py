# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 21:38:06 2022
...
print("The order that fits the data the best is the quadratic function as it is the one with the closes Chisquared to One")
