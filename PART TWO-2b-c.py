# -*- coding: utf-8 -*-
"""
Created on Thu Apr 14 05:49:03 2022
...
def deriv(theta, omega):
    dTheta = omega
    domega = -gl*theta*np.sin(theta)
    
    return dTheta, domega

theta0 = np.linspace(-np.pi, np.pi, 50)
omega0 = np.linspace(0,20,50)

zipA = zip(theta0, omega0)

for int1, int2 in zipA:
    theta[0] = int1
    omega[0] = int2
